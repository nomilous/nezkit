...
GitSeed = (function() {
  ...
  GitSeed.prototype.save = function() {
    try {
      ...
      return this.superTask.notify.info.good('saved seed', this.control);
    } catch (error) {
      this.superTask.notify.info.bad('save seed failed', error.toString());
      throw error;
    }
  };
  ...
  GitSeed.action = function(action, Repo, repoArray, superTask, callback) {
    var event, fail, info, moo, repo, succeed, targs;
