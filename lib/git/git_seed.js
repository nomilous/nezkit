...
GitSeed = (function() {
  ...
  GitSeed.prototype.action = function(name, callback) {
    var failed, repo, success, targs, tasks;
    targs = [];
    tasks = sequence((function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(function() {
          return nodefn.call(_this.Plugin.Package[name], targs.pop(), _this.deferral);
        });
      }
      return _results;
    }).call(this));
